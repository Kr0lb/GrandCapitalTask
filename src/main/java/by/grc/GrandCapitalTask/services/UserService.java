...
public class UserService extends BaseService<User, UserRepository> {
    ...
    public List<User> searchUser(LocalDate dateOfBirth, String phone, String name, String email) {
        Specification<User> spec = Specification.where(UserSpecification.dateOfBirthGreaterThan(dateOfBirth))
